              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="relative flex items-center justify-center w-20 h-20 p-4 mb-3 transition-transform bg-white rounded-xl shadow-md dark:bg-slate-800 hover:scale-110">
                      {skill.icon}
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
